...
public class SeleniumFormFill {
        ...
        public void testFillWebForm() {
            ...
            WebElement color = driver.findElement(By.name("my-color"));
            ...
            Assert.assertTrue(
                    currentUrl.contains("application.html"),
                    "After submit, URL should contain application.html but was: " + currentUrl
            );
            Assert.assertTrue(
